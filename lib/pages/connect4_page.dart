...
class _Connect4PageState extends State<Connect4Page>
  ...
  bool _isInitialized = false;    //just added 07/01/2026 to avoid re-initializing
          ...
          onPressed: () {
            showCupertinoDialog(
              ...
              builder: (context) => CupertinoAlertDialog(
                title: const Text('Connect 4 Rules'),
                content: const Text('\nThe goal is to connect 4 discs of your color next to each other.\n\nYou can win:\n• Horizontally\n• Vertically\n• Diagonally'),
                actions: [
